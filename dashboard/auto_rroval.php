   ...
   <body>
      ...
      <div class="br-mainpanel">
         ...
         <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">Auto Approval List</h4>
            <p class="mg-b-0"></p>
         </div>
               ...
               <div class="table-wrapper" style="overflow-x:auto;">
                  <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tr style="background-color:#4e73df; color:white;">
                                            ...
                                            <th style="color:white;">PROCESS</th>
                                        </tr>
                        					 <?php
                        					 $i=1;
                        					 $query=mysqli_query($con,"SELECT * FROM `auto_approval` WHERE `status`='Pending' order by id desc");
                        			 ...
                        			 <tr>	
                        				...
                        				<td style="background-color:#F1EFC0; color:black;"><a href="../payment_receipt/<?php echo $row['image'];?>" target="_blank"><img src="../payment_receipt/<?php echo $row['image'];?>" width='100px;'>	</a></td>    

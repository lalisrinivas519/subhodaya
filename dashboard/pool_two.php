               ...
               <div class="table-wrapper" style="overflow-x:auto;">
                  <table id="datatable1" class="table display responsive nowrap" >
                    ...
                    <tr style="background-color:#29758E; color:white;">
					 ...
					 <?php
									$i=1;
									$query = mysqli_query($con,"SELECT * FROM `pool_two`");
									if(mysqli_num_rows($query)>0){
										...
										?>
										 ...
										 <td style="background-color:#F1EFC0; color:black;"><?php echo $row['c_side']; ?></td>
										 <td style="background-color:#F1EFC0; color:black;"><?php echo $row['d_side']; ?></td>
										  </tr>
                                        <?php
											$i++;
										}
